...
## Conditions de réutilisation des contenus de Garance
...
Le site web de Garance a été réalisé par la société Sparna et par le Lab des Archives nationales de France, à partir de données produites par les agents scientifiques des AnF.

Le triplestore QLever a été déployé et est maintenu par la société Zazuko GmbH.
Le site web et le triplestore sont hébergés par Scaleway, dans le cadre d’une prestation commandée par le Département des systèmes d’information des AnF.

Pour plus d’informations sur les composants logiciels open-source utilisés pour produire Garance, voyez [la page sur le projet](../project).
