...
Le graphique ci-dessous donne une idée de la répartition des descriptions dans la collection initiale de fichiers, par type de notice puis par type d’entité.
...
![Tableau récapitulatif des étapes de traitement des données dans Garance : 70 000 fichiers RDF, sérialisation JSON-LD, génération du site statique](../../../assets/images/tableau_garance_fr.png "Étapes de traitement des données dans Garance")
