...
![Tableau de statistiques sur les relations entre agents producteurs dans les fichiers source en janvier 2025](../../../assets/images/tableau_garance_fr.png "Nombre de relations entre les notices d’agents producteurs dans les fichiers source en janvier 2025")
...
- Explorer des pistes pour l’avenir du système d’information des AnF, qu’il s’agisse des données de référence elles-mêmes ou des fonctionnalités de ce SI.
...
- Suivi d’une chaîne de caractères construite à partir de l’identifiant unique local de l’entité dans le système d’information archivistique (SIA) des AnF, ou, dans les rares cas où l’entité a été ajoutée, d’un identifiant forgé à partir du nom privilégié en français de l’entité.
...
Le projet a été présenté rapidement lors de la conférence annuelle SemWeb.Pro 2025, fin novembre 2025 à Paris. Retrouvez le poster et l’enregistrement vidéo de la présentation [ici](https://semweb.pro/conference/2025/presentation/clavaud-archives-garance/).